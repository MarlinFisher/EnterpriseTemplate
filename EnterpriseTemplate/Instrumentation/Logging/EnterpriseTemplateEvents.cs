namespace EnterpriseTemplate.Instrumentation.Logging
{
    ...
    [EventSource(Name = "EnterpriseTemplate")]
    public class EnterpriseTemplateEvents : EventSource
    {
        #region Instance

        private static readonly Lazy<EnterpriseTemplateEvents> Instance =
            new Lazy<EnterpriseTemplateEvents>(() => new EnterpriseTemplateEvents());

        private EnterpriseTemplateEvents()
        {
        }

        public static EnterpriseTemplateEvents Log
        {
            get
            {
        ...
        [Event(100, Level = EventLevel.Verbose, Keywords = Keywords.Application, Task = Tasks.Initialize, 
            Opcode = Opcodes.Starting, Version = 1)]
        ...
        [Event(101, Level = EventLevel.Informational, Keywords = Keywords.Application, Task = Tasks.Initialize, 
            Opcode = Opcodes.Start, Version = 1)]
        ...
        [Event(102, Level = EventLevel.Error, Keywords = Keywords.Application, Task = Tasks.Tracing, 
            Opcode = Opcodes.Error, Version = 1)]
        ...
        [Event(2, Message = "Application Failure: {0}", Keywords = Keywords.Application, Level = EventLevel.Critical)]
        public void ApplicationFailure(string message)
        {
        ...
        [Event(250, Level = EventLevel.Informational, Keywords = Keywords.DataAccess, Task = Tasks.Initialize, 
            Version = 1)]
        ...
        [Event(251, Level = EventLevel.Informational, Keywords = Keywords.DataAccess, Task = Tasks.Initialize, 
            Version = 1)]
        ...
        [Event(252, Level = EventLevel.Informational, Keywords = Keywords.DataAccess, Task = Tasks.Initialize, 
            Version = 1)]
        ...
        [Event(290, Level = EventLevel.Informational, Keywords = Keywords.DataAccess, Task = Tasks.SaveExpense, 
            Opcode = Opcodes.Start, Version = 1)]
        ...
        [Event(291, Level = EventLevel.Informational, Keywords = Keywords.DataAccess, Task = Tasks.SaveExpense, 
            Opcode = Opcodes.Finish, Version = 1)]
        ...
        [Event(292, Level = EventLevel.Verbose, Keywords = Keywords.DataAccess, Task = Tasks.SaveExpense, 
            Opcode = Opcodes.CacheUpdate, Version = 1)]
        ...
        [Event(293, Level = EventLevel.Verbose, Keywords = Keywords.DataAccess, Task = Tasks.SaveExpense, 
            Opcode = Opcodes.CacheUpdate, Version = 1)]
        ...
        [Event(294, Level = EventLevel.Verbose, Keywords = Keywords.DataAccess, Task = Tasks.SaveExpense, 
            Opcode = Opcodes.QueryStart, Version = 1)]
        ...
        [Event(295, Level = EventLevel.Verbose, Keywords = Keywords.DataAccess, Task = Tasks.SaveExpense, 
            Opcode = Opcodes.QueryFinish, Version = 1)]
        ...
        [Event(300, Level = EventLevel.Informational, Keywords = Keywords.DataAccess, Task = Tasks.LoadAllExpenses, 
            Opcode = Opcodes.Start, Version = 1)]
        ...
        [Event(301, Level = EventLevel.Informational, Keywords = Keywords.DataAccess, Task = Tasks.LoadAllExpenses, 
            Opcode = Opcodes.Finish, Version = 1)]
        ...
        [Event(320, Level = EventLevel.Informational, Keywords = Keywords.DataAccess, 
            Task = Tasks.GetExpensesForApproval, Opcode = Opcodes.Start, Version = 1)]
        ...
        [Event(321, Level = EventLevel.Informational, Keywords = Keywords.DataAccess, 
            Task = Tasks.GetExpensesForApproval, Opcode = Opcodes.Finish, Version = 1)]
        ...
        [Event(322, Level = EventLevel.Error, Keywords = Keywords.DataAccess, Task = Tasks.LoadAllExpenses, 
            Opcode = Opcodes.Error, Version = 1)]
        ...
        [Event(323, Level = EventLevel.Verbose, Keywords = Keywords.DataAccess, Task = Tasks.GetExpensesForApproval, 
            Opcode = Opcodes.CacheHit, Version = 1)]
        ...
        [Event(324, Level = EventLevel.Verbose, Keywords = Keywords.DataAccess, Task = Tasks.GetExpensesForApproval, 
            Opcode = Opcodes.QueryFinish, Version = 1)]
        ...
        [Event(325, Level = EventLevel.Warning, Keywords = Keywords.DataAccess, Task = Tasks.GetExpensesForApproval, 
            Opcode = Opcodes.QueryNoResults, Version = 1)]
        ...
        [Event(326, Level = EventLevel.Verbose, Keywords = Keywords.DataAccess, Task = Tasks.GetExpensesForApproval, 
            Opcode = Opcodes.CacheUpdate, Version = 1)]
        ...
        [Event(327, Level = EventLevel.Verbose, Keywords = Keywords.DataAccess, Task = Tasks.GetExpensesForApproval, 
            Opcode = Opcodes.QueryStart, Version = 1)]
        ...
        // ExpenseApproved
        [Event(400, Level = EventLevel.Informational, Keywords = Keywords.DataAccess, Task = Tasks.ApproveExpense, 
            Version = 1, Message = "The expense '{0}' for user '{1}' was approved by user '{2}'.")]
        ...
        [Event(330, Level = EventLevel.Informational, Keywords = Keywords.UserInterface, Task = Tasks.SaveExpense, 
            Opcode = Opcodes.Start, Version = 1)]
        ...
        [Event(331, Level = EventLevel.Informational, Keywords = Keywords.UserInterface, Task = Tasks.SaveExpense, 
            Opcode = Opcodes.Finish, Version = 1)]
        ...
        [Event(332, Level = EventLevel.Error, Keywords = Keywords.UserInterface, Task = Tasks.SaveExpense, 
            Opcode = Opcodes.Error, Version = 1)]
        ...
        [Event(1000, Level = EventLevel.Error, Keywords = Keywords.General, Task = Tasks.Tracing, Opcode = Opcodes.Error, 
            Version = 1)]
        ...
        [Event(1001, Level = EventLevel.Informational, Keywords = Keywords.General, Task = Tasks.Tracing, Version = 1, 
            Message = "Method {0}.{1} executed")]
        public void TracingBehaviorVirtualMethodIntercepted(
        ...
        public void TracingBehaviorVirtualMethodIntercepted(IMethodInvocation input)
        {
            ...
            if (this.IsEnabled(EventLevel.Informational, Keywords.General))
            {
                ...
                {
                    var arguments = string.Join(",", input.Arguments.OfType<object>());
                    if (input.MethodBase.DeclaringType != null)
                    {
                        this.TracingBehaviorVirtualMethodIntercepted(
        ...
        [Event(1002, Level = EventLevel.Informational, Keywords = Keywords.General, Task = Tasks.Tracing, Version = 1, 
        ...
        [Event(1003, Level = EventLevel.Informational, Keywords = Keywords.General, Task = Tasks.Tracing, Version = 1, 
